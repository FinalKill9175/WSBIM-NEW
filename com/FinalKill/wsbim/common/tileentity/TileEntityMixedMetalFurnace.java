...
public class TileEntityMixedMetalFurnace extends TileEntity implements IUpgradedFurnace{
...
private EnumFurnaceType type;
	...
	public void updateDoubleFurnace(){
		...
		else if((inv[input_2] !=null && FurnaceRecipes.smelting().getSmeltingResult(inv[input_2]) !=null)){
			if(inv[fuel] !=null && TileEntityFurnace.isItemFuel(inv[fuel]) && !this.isBurning()){
	...
	public EnumFurnaceType getFurnaceType(){
		//TODO change type
		return EnumFurnaceType.MIXEDMETAL;
	}
