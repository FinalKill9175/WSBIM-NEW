...
public class TileEntityDiamondFurnace extends TileEntity implements IUpgradedFurnace{
...
private EnumFurnaceType type;
	...
	public void updateFurnace(){
		...
		if((inv[input] !=null && FurnaceRecipes.smelting().getSmeltingResult(inv[input]) !=null)){
			...
			if(this.cookTime > 0 && (!this.isBurning() && inv[output] == null) || inv[input] == null){
				this.cookTime = 0;
			}
	...
	public EnumFurnaceType getFurnaceType(){
		//TODO change type
		return EnumFurnaceType.DIAMOND;
	}
