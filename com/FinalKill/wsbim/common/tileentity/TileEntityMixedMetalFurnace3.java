...
public class TileEntityMixedMetalFurnace3 extends TileEntity implements IUpgradedFurnace{
...
private EnumFurnaceType type;
	...
	public void updateEntity(){
		if(!worldObj.isRemote){
			...
			if((inv[input] !=null && FurnaceRecipes.smelting().getSmeltingResult(inv[input]) !=null)){
				...
				if(this.cookTime > 0 && (!this.isBurning() && inv[output] == null && inv[output_2] == null && inv[output_3] == null && inv[output_4] == null) || inv[input] == null && inv[input_2] == null && inv[input_3] == null && inv[input_4] == null){
					this.cookTime = 0;
				}
		 ...
		 if((inv[input_2] !=null && FurnaceRecipes.smelting().getSmeltingResult(inv[input_2]) !=null)){
				...
				if(this.cookTime2 > 0 && (!this.isBurning() && inv[output] == null && inv[output_2] == null && inv[output_3] == null && inv[output_4] == null) || inv[input] == null && inv[input_2] == null && inv[input_3] == null && inv[input_4] == null){
					this.cookTime2 = 0;
				}
			}
			else{
		 ...
		 if((inv[input_3] !=null && FurnaceRecipes.smelting().getSmeltingResult(inv[input_3]) !=null)){
				if(inv[fuel] !=null && TileEntityFurnace.isItemFuel(inv[fuel]) && !this.isBurning()){
					if(inv[output_3] !=null && inv[output_3].stackSize < FurnaceRecipes.smelting().getSmeltingResult(inv[input_3]).getMaxStackSize()){
					this.itemBurnTime = TileEntityFurnace.getItemBurnTime(inv[fuel]);
				...
				if(this.isBurning()){
					...
					if(inv[output_3] == null){
						++this.cookTime3;
						if(this.cookTime3 == this.getFurnaceType().getTicksPerSmelt()){
							ItemStack result = FurnaceRecipes.smelting().getSmeltingResult(inv[input_3]);
							if(inv[input_3].stackSize == 1){
								inv[input_3] = inv[input_3].getItem().getContainerItem(inv[input_3]);
							}
							else{
								inv[input_3].stackSize -=1;
							}
							if(inv[output_3] == null){
							inv[output_3] = new ItemStack(result.getItem(), 1, result.getItemDamage());
							}
					...
					else if(FurnaceRecipes.smelting().getSmeltingResult(inv[input_3]).getItem() == inv[output_3].getItem() && inv[output_3].stackSize < FurnaceRecipes.smelting().getSmeltingResult(inv[input_3]).getMaxStackSize()){
				...
				if(this.cookTime3 > 0 && (!this.isBurning() && inv[output] == null && inv[output_2] == null && inv[output_3] == null && inv[output_4] == null) || inv[input] == null && inv[input_2] == null && inv[input_3] == null && inv[input_4] == null){
					this.cookTime3 = 0;
				}
			}
			else{
		 ...
		 if((inv[input_4] !=null && FurnaceRecipes.smelting().getSmeltingResult(inv[input_4]) !=null)){
				if(inv[fuel] !=null && TileEntityFurnace.isItemFuel(inv[fuel]) && !this.isBurning()){
					if(inv[output_4] !=null && inv[output_4].stackSize < FurnaceRecipes.smelting().getSmeltingResult(inv[input_4]).getMaxStackSize()){
					this.itemBurnTime = TileEntityFurnace.getItemBurnTime(inv[fuel]);
				...
				if(this.isBurning()){
					...
					if(inv[output_4] == null){
						++this.cookTime4;
						if(this.cookTime4 == this.getFurnaceType().getTicksPerSmelt()){
							ItemStack result = FurnaceRecipes.smelting().getSmeltingResult(inv[input_4]);
							if(inv[input_4].stackSize == 1){
								inv[input_4] = inv[input_4].getItem().getContainerItem(inv[input_4]);
							}
							else{
								inv[input_4].stackSize -=1;
							}
							if(inv[output_4] == null){
							inv[output_4] = new ItemStack(result.getItem(), 1, result.getItemDamage());
							}
					...
					else if(FurnaceRecipes.smelting().getSmeltingResult(inv[input_4]).getItem() == inv[output_4].getItem() && inv[output_4].stackSize < FurnaceRecipes.smelting().getSmeltingResult(inv[input_4]).getMaxStackSize()){
				...
				if(this.cookTime4 > 0 && (!this.isBurning() && inv[output] == null && inv[output_2] == null && inv[output_3] == null && inv[output_4] == null) || inv[input] == null && inv[input_2] == null && inv[input_3] == null && inv[input_4] == null){
		this.cookTime4 = 0;
				}
			}
			else{
	...
	public EnumFurnaceType getFurnaceType(){
		//TODO change type
		return EnumFurnaceType.MIXEDMETAL3;
	}
    ...
    public void readFromNBT(NBTTagCompound nbt)
    {
        ...
        this.cookTime3 = nbt.getInteger("cookTime3");
        this.cookTime4 = nbt.getInteger("cookTime4");
    ...
    public void writeToNBT(NBTTagCompound nbt)
    {
        ...
        nbt.setInteger("cookTime3", this.cookTime3);
        nbt.setInteger("cookTime4", this.cookTime4);
     ...
     */
    @SideOnly(Side.CLIENT)
    public int getCookProgress3Scaled(int p_145953_1_)
    {
        return this.cookTime3 * p_145953_1_ / this.getFurnaceBlock().getFurnaceType().getTicksPerSmelt();
    }
    /**
     * Returns an integer between 0 and the passed value representing how close the current item is to being completely
     * cooked
     */
    @SideOnly(Side.CLIENT)
    public int getCookProgress4Scaled(int p_145953_1_)
    {
        return this.cookTime4 * p_145953_1_ / this.getFurnaceBlock().getFurnaceType().getTicksPerSmelt();
    }
