...
public class TileEntityObsidianChest extends TileEntity implements IUpgradedChest {
		    ...
		    public void updateEntity()
		    {
		       ...
		       //S this.lidAngle += 0.001F;
		        ...
		        if (numUsingPlayers > 0 && lidAngle == 0.0F)
		        {
		            ...
		            worldObj.playSoundEffect(d, (double) yCoord + 0.5D, d1, "random.chestopen", 0.5F, worldObj.rand.nextFloat() * 0.1F + 0.4F);
		        }
		        if (numUsingPlayers == 0 && lidAngle > 0.0F || numUsingPlayers > 0 && lidAngle < 1.0F)
		        {
		            ...
		            if (lidAngle < f2 && f1 >= f2)
		            {
		                ...
		                worldObj.playSoundEffect(d2, (double) yCoord + 0.5D, d3, "random.chestclosed", 0.5F, worldObj.rand.nextFloat() * 0.1F + 0.4F);
		            }
		            if (lidAngle < 0.0F)
		            {
		                lidAngle = 0.0F;
