...
public class GuiAdvancedCraftingTable extends GuiContainer{
    ...
    public GuiAdvancedCraftingTable(InventoryPlayer p_i1084_1_, TileEntityAdvancedCraftingTable table)
    {
        super(new ContainerAdvancedCraftingTable(p_i1084_1_, table));
    }
