...
public class GuiWSBIMSettingsHUD extends GuiScreen{
	private Minecraft mc;
	
	public GuiWSBIMSettingsHUD(Minecraft minecraft){
		this.mc = minecraft;
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("HUD (Ingame GUI) Customization", new Object[0]), this.width / 2, 15, 16777215);
