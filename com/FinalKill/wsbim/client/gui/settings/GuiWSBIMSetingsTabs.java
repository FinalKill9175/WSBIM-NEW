...
public class GuiWSBIMSetingsTabs extends GuiScreen{
	private Minecraft mc;
	
	public GuiWSBIMSetingsTabs(Minecraft minecraft){
		this.mc = minecraft;
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("Gui Container Tabs Customization", new Object[0]), this.width / 2, 15, 16777215);
	...
	public void openPrevGui(Minecraft mc){
		mc.displayGuiScreen(new GuiWSBIMSettings(mc, null));
	}
}
