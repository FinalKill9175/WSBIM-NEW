...
public class GuiButtonOpenGUI extends GuiButton {
	...
	public GuiButtonOpenGUI(Option option, int p_i1021_1_, int p_i1021_2_, int p_i1021_3_,
    ...
    public boolean mousePressed(Minecraft p_146116_1_, int p_146116_2_, int p_146116_3_)
    {
    	if(this.enabled && this.visible && p_146116_2_ >= this.xPosition && p_146116_3_ >= this.yPosition && p_146116_2_ < this.xPosition + this.width && p_146116_3_ < this.yPosition + this.height){
    		p_146116_1_.displayGuiScreen(op.getGuiToOpen());
    		return true;
    	}
    	else return false;
    }
    ...
    public void drawButton(Minecraft mc, int x, int y){
    	...
    	List<String> list = Description.getItemDescription(op.variableName);
