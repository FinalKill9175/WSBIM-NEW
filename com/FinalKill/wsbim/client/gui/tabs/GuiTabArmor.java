...
public class GuiTabArmor extends GuiTab{
	public GuiTabArmor(Minecraft mc, int id, GuiContainer guiContainer,
	...
	public void renderTab(float partialTick, int mouseX, int mouseY) {
		this.selected = GuiContainerOverlayTabs.armorTab !=null ? GuiContainerOverlayTabs.armorTab.selected : false;
		//MUST DO TODO
		...
		if(this.isSelected() || !this.isSelected())GuiContainerOverlayTabs.renderItemStack(new ItemStack(Items.iron_chestplate), x + 6, y + 6, partialTick);
	...
	public boolean canClickOnTab() {
		return GuiContainerOverlayTabs.armorTabAvailable;
	}

	@Override
	public void onGuiClosed() {
		GuiContainerOverlayTabs.armorTab = null;
	}
