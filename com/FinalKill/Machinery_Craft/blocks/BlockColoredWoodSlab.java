...
public class BlockColoredWoodSlab extends BlockColoredStoneSlab {

	protected BlockColoredWoodSlab(int stone) {
		super(stone, Material.wood);
			}
  ...
  public int getRenderColor(int p_149741_1_)
  {
  	...
  	Block[] coloredStones = MachineryCraft.blocks.coloredWoodSlab;
  ...
  public int colorMultiplier(IBlockAccess blocks, int x, int y, int z)
  {
  	...
  	if(blocks.getBlock(x, y, z) instanceof BlockColoredWoodSlab){
  		
  		Block[] coloredStones = MachineryCraft.blocks.coloredWoodSlab;
  		
  		for(int i = 0; i<MachineryCraft.blocks.coloredWoodSlab.length; i++){
